  ...
  return (
    <footer className="bg-white pt-24 pb-10 border-t border-gray-100 relative overflow-hidden">
      <Container>
        ...
        <div className="flex flex-col items-center mb-24 relative z-10 font-inter">
        ...
        <div className="font-inter grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end border-t border-gray-100 pt-8 gap-8">
          <div className="flex items-center gap-6">
            ...
            <a href="#" className="text-main hover:text-[#333CF5] transition-colors"> <FaFacebookF alt="PulseX" className="w-6 h-6 object-contain" /></a>
            <a href="#" className="text-main hover:text-[#333CF5] transition-colors"> <FaXTwitter alt="PulseX" className="w-6 h-6 object-contain" /></a>
          </div>
