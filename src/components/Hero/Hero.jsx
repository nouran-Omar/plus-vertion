...
// تأكدي من مسار الصورة الصحيح
import heartImg from '../../../public/image/HomeRightSide.svg';
...
const Hero = () => {
  return (
    <section id="home" className="relative bg-[#F9FAFB] overflow-hidden min-h-[calc(100vh-82px)] flex items-center justify-center pt-20 pb-40">
      <div className="w-full max-w-[1440px] mx-auto px-6 md:px-20">
        <div className="lg:grid lg:grid-cols-2 items-center gap-16">
          ...
          <div className="relative h-[500px] w-full flex justify-center items-center opacity-0 animate-fade-right" style={{ animationFillMode: 'forwards' }}>
            ...
            <HiOutlineBolt className="absolute bottom-[20%] left-[5%] w-5 h-5 text-[#DBCC28] animate-float-slow delay-2" />
            ...
            <div className="floating-card bottom-[10%] right-[-5%] ">
               <div className="absolute -top-6 -right-2 w-10 h-10 flex items-center justify-center animate-bounce">
        ...
        {/* سكرول إنديكيتور */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 cursor-pointer opacity-60 animate-bounce">
          <span className="text-[#757575] text-xs font-bold tracking-widest">Scroll to explore</span>
