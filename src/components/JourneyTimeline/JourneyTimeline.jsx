...
const TimelineItem = ({ step, isFirst }) => {
  ...
  return (
    <div ref={itemRef} className={`relative flex flex-col md:flex-row items-start justify-between w-full ${isFirst ? 'mb-12' : 'mb-[120px]'} last:mb-0 ${isLeft ? '' : 'md:flex-row-reverse'}`}>
